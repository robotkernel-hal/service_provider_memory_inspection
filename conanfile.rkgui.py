...
class service_provider_memory_inspection_rkgui(ConanFile):
    name = "service_provider_memory_inspection_rkgui"
    ...
    def requirements(self):
        self.requires(f"service_provider_memory_inspection_ln_msgdef/{self.version}@{self.user}/{self.channel}")
