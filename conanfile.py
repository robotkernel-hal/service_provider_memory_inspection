...
class MainProject(ConanFile):
    ...
    description = "robotkernel-5 service provider for memory inspeciton."
    settings = "os", "compiler", "build_type", "arch"
    exports_sources = "src/*", "README.wiki", "project.properties", "service_provider_memory_inspection.pc.in", "Makefile.am", "m4/*", "configure.ac", "LICENSE"
